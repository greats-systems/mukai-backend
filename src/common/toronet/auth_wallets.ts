...
export class ToroGateway {
    ...
    public async updateKeyPassword(address: string, oldPassword: string, newPassword: string): Promise<any> {
        const data = {
            op: 'updatekeypwd',
            params: [
                {
    ...
    public async deleteKey(address: string, password: string = 'toronet'): Promise<any> {
        const data = {
            op: 'deletekey',
            params: [
                {
