...
export class CreateDemandOrderDto {
  ...
  @ApiProperty({
    description: 'ID of the sales person handling the order',
    example: '2884ed1c-9a32-46c9-bb9d-954f40abd69c',
  })
  @IsNotEmpty()
  @IsString()
  provider_id: string;
  ...
  @ApiProperty({
    ...
    example: '56619657-0c47-40ee-8711-aee9b8f98122',
  })
  @IsNotEmpty()
  @IsString()
  customer_id: string;
  ...
  @ApiPropertyOptional({
    description: 'Amount bid by client',
    example: 50.0,
    default: 0.0,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Amount agreed by customer and final provider',
    example: 50.0,
    default: 0.0,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Amount bid by providers',
    example: [50.0],
    default: [0.0],
  })
  @IsOptional()
  ...
  @ApiProperty({
    type: () => CreateDemandRequestInventoryDto,
