...
export class Business {
  ...
  @ApiProperty({
    ...
    example: 'Quality Coffee Since 2020',
    required: false,
  })
  @Column({ nullable: true })
  motto: string;
  ...
  @ApiProperty({
    description: 'Tax compliance number',
    example: 'TAX-123456',
    required: false,
  })
  ...
  @ApiProperty({
    ...
    example: 'Specialty coffee roaster',
    required: false,
  })
  @Column({ nullable: true })
  description: string;
  ...
  @ApiProperty({
    description: 'Additional specialization',
  ...
  @ApiProperty({
    ...
    example: 'https://premiumroasters.com',
    required: false,
  })
  @Column({ nullable: true })
  website: string;
